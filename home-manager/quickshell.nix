...

{
  ...
  xdg.configFile = {
    ...
    "quickshell/gallery-status/WallpaperAmbient.qml".source = ../configs/quickshell/gallery-status/WallpaperAmbient.qml;
    "quickshell/gallery-status/animations/AmbientEffects.qml".source = ../configs/quickshell/gallery-status/animations/AmbientEffects.qml;
    "quickshell/gallery-status/animations/LightGalleryAmbient.qml".source = ../configs/quickshell/gallery-status/animations/LightGalleryAmbient.qml;
    "quickshell/gallery-status/animations/WhitePainting1Ambient.qml".source = ../configs/quickshell/gallery-status/animations/WhitePainting1Ambient.qml;
    "quickshell/gallery-status/animations/WhitePainting2Ambient.qml".source = ../configs/quickshell/gallery-status/animations/WhitePainting2Ambient.qml;
    "quickshell/gallery-status/animations/WhitePainting3Ambient.qml".source = ../configs/quickshell/gallery-status/animations/WhitePainting3Ambient.qml;
    "quickshell/gallery-status/animations/WhitePainting4Ambient.qml".source = ../configs/quickshell/gallery-status/animations/WhitePainting4Ambient.qml;
    "quickshell/gallery-status/animations/WhitePainting5Ambient.qml".source = ../configs/quickshell/gallery-status/animations/WhitePainting5Ambient.qml;
    "quickshell/gallery-status/animations/DarkPainting1Ambient.qml".source = ../configs/quickshell/gallery-status/animations/DarkPainting1Ambient.qml;
    "quickshell/gallery-status/animations/DarkPainting2Ambient.qml".source = ../configs/quickshell/gallery-status/animations/DarkPainting2Ambient.qml;
    "quickshell/gallery-status/animations/DarkPainting3Ambient.qml".source = ../configs/quickshell/gallery-status/animations/DarkPainting3Ambient.qml;
    "quickshell/gallery-status/animations/DarkPainting4Ambient.qml".source = ../configs/quickshell/gallery-status/animations/DarkPainting4Ambient.qml;
    "quickshell/gallery-status/animations/DarkPainting5Ambient.qml".source = ../configs/quickshell/gallery-status/animations/DarkPainting5Ambient.qml;
