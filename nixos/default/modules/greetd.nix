...
let
  sessionDataDir = config.services.displayManager.sessionData.desktops;
  regreetCommand = lib.escapeShellArgs ([
...
in
{
  ...
  # The bspwm X session is generated by services.xserver.windowManager.bspwm.
